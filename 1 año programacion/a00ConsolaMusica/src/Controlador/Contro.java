...
//					fecha
		...
		do {
			...
			if (res.equals("si")) {
				...
				if (r==1) {
					...
					c = BuscadorCanciones(Usuario.load(userCa.getNick()));
					
					if (c==null) System.out.println("No se encontro la cancion");
					else p.addSong(c);
				}
	...
	public void MenuInvitado() {
		...
		if (resinv.equals("b") || resinv.equals("B")) {
			...
			Buscador(Usuario.load("Invitado"));
